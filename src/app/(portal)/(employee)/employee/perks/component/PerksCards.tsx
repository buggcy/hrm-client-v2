...
const PerkCards: FunctionComponent<PerkCardProps> = ({ data }) => {
  const [records, setRecords] = useState<PerkRecordApiResponse | null>(null);
  useEffect(() => {
    if (data) {
      setRecords(data);
    }
        ...
        <CardContent>
          {activeTab === 'Available' && (
            <ScrollArea className="mt-3 h-48 w-full">
              <div className="flex flex-col gap-4">
                {records?.availableData &&
                records?.availableData?.length > 0 ? (
                        ...
                        >
                          <div className="mb-2 flex items-center justify-between">
                            ...
                            <div>
                              ...
                              {perk?.assignedIncrementAmount > 0 && (
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger>
                                      <Badge
