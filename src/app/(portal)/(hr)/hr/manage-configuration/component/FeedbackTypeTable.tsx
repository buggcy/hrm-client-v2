...
import { feedbackTypeColumns } from '@/components/data-table/columns/hr-feedbackType.columns';
...
interface FeedbackTypeTableProps {}
const FeedbackTypeTable: FunctionComponent<FeedbackTypeTableProps> = () => {
  ...
  useEffect(() => {
    if (debouncedSearchTerm) {
      mutate({ query: debouncedSearchTerm, page, limit, status: 'feedback' });
    } else {
      void (async () => {
        await refetch();
      })();
...
export default FeedbackTypeTable;
