...
interface DesignationTypeTableProps {}
const DesignationTypeTable: FunctionComponent<
  DesignationTypeTableProps
> = () => {
    ...
    <>
      ...
      {isLoading || isFetching ? (
        ...
        <ConfigurationTypeDataTable
          ...
          data={tableData || []}
          columns={designationTypeColumns}
          pagination={{
...
export default DesignationTypeTable;
