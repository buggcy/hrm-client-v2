...
import { AddExtraLeaveModal } from '../../../../manage-leave/component/AddExtraLeave';
import UpdateLeaveForm from '../../../../manage-leave/component/UpdateLeaveForm';
...
const ManageLeaves = ({ empId }: ManageLeavesProps) => {
  const selectedEmployeeId = empId || '';
