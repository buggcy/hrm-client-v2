...
import { EducationTypeRowActions } from '../actions/hr-education-type.actions';
import { DataTableColumnHeader } from '../data-table-column-header';

export const educationTypeColumns: ColumnDef<ConfigurationType>[] = [
  {
...

  {
    ...
    cell: ({ row }) => <EducationTypeRowActions row={row} />,
  },
];
