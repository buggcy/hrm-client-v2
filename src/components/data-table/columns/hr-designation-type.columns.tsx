...
import { DesignationTypeRowActions } from '../actions/hr-designation-type.actions';
import { DataTableColumnHeader } from '../data-table-column-header';

export const designationTypeColumns: ColumnDef<ConfigurationType>[] = [
  {
...

  {
    ...
    cell: ({ row }) => <DesignationTypeRowActions row={row} />,
  },
];
