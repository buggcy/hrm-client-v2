...
import { FeedbackTypeRowActions } from '../actions/hr-feedbackType.actions';
import { DataTableColumnHeader } from '../data-table-column-header';

export const feedbackTypeColumns: ColumnDef<ConfigurationType>[] = [
  {
...

  {
    ...
    cell: ({ row }) => <FeedbackTypeRowActions row={row} />,
  },
];
