...
import { HrComplaintRowActions } from '../actions/hr-complaint.actions';
import { DataTableColumnHeader } from '../data-table-column-header';

export const hrComplaintColumns: ColumnDef<ComplaintListType>[] = [
  {
  ...
  },
  {
    ...
    cell: ({ row }) => <HrComplaintRowActions row={row} />,
  },
];
