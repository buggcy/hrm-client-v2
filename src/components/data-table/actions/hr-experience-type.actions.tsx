...
export function ExperienceTypeRowActions({ row }: DataTableRowActionsProps) {
    ...
    onError: (err: AxiosError<MessageErrorResponse>) => {
      toast({
        ...
        description:
          ...
          'Error on delete the experience type!',
        variant: 'error',
      });
    },
    onSuccess: response => {
  ...
  return (
    <Dialog>
      ...
      <ConfirmDialog
        ...
        isPending={isPending}
        description={'Are your sure you want to delete this experience type?'}
