...
export function FeedbackTypeRowActions({ row }: DataTableRowActionsProps) {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onError: (err: AxiosError<MessageErrorResponse>) => {
      toast({
        title: 'Error',
        description:
          err?.response?.data?.message || 'Error on delete the feedback type!',
        variant: 'error',
      });
    },
    onSuccess: response => {
  ...
  return (
    <Dialog>
      ...
      <ConfirmDialog
        ...
        isPending={isPending}
        description={'Are your sure you want to delete this feedback type?'}
