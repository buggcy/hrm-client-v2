...
export const DEFAULT_PERSONA: IPersona = {
  ...
  system_prompt:
    'You are a friendly and knowledgeable customer support representative. Your goal is to assist customers with their inquiries, providing clear and concise answers, troubleshooting issues, and ensuring a positive experience.',
};
...
export const PersonasDescriptions: Record<IPersona['persona_id'], string> = {
  ...
  p5317866: 'Offer a digital extension at lower cost',
  p7fb0be3: 'Offer mock conversations for corporate education',
  p88964a7: 'Offer a digital extension to at low cost',
